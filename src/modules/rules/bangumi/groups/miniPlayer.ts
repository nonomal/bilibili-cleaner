...
export const bangumiMiniPlayerItems: Item[] = [
    ...
    },
    {
        ...
        enableFn: async () => {
            try {
                ...
                if (oldZoom) {
                    document.documentElement.style.setProperty('property', `${oldZoom}`)
                }
                    ...
                    if (player) {
                        ...
                        player.addEventListener('wheel', (e) => {
                            if (flag) {
                                ...
                                if (zoom !== lastZoom) {
                                    lastZoom = zoom
                                    document.documentElement.style.setProperty('property', `${zoom}`)
    ...
    },
    {
        ...
        enableFn: async () => {
            ...
            if (x && y) {
                document.documentElement?.style.setProperty('--mini-player-translate-x', `${x}px`)
                document.documentElement?.style.setProperty('--mini-player-translate-y', `${y}px`)
            }
